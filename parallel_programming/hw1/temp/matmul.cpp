...
void ParRecMM(LL**z, LL **x, LL **y, int n, int threadId){
	...
	printMat(z22,n/2);
	cout<<"2......\n";
	cout<<"before enquing threadId: "<<threadId<<"\n";
	Work w=getWorkObject(&ParRecMM,z11,x11,y11,n/2,1);
	printMat(w.x,n/2);
	allThreads[threadId]->myDeque.push_back(w);
	cout<<"pushed to queue\n";
	// allThreads[threadId]->myDeque.push_back(getWorkObject(&ParRecMM,z12,x11,y12,n/2,2));
	// allThreads[threadId]->myDeque.push_back(getWorkObject(&ParRecMM,z21,x21, y11,n/2,3));
	// ParRecMM(z22,x21, y12, n/2,threadId);


	// allThreads[threadId]->myDeque.push_back(getWorkObject(&ParRecMM,z11,x12, y21, n/2,1));
	// allThreads[threadId]->myDeque.push_back(getWorkObject(&ParRecMM,z12,x12, y22, n/2,2));
	// allThreads[threadId]->myDeque.push_back(getWorkObject(&ParRecMM,z21,x22, y21, n/2,3));
...
int main(){
	...
	Work w=getWorkObject(&ParRecMM,z,x,y,n,1);
